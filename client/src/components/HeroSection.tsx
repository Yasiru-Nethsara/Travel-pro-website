      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="space-y-8 lg:space-y-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                size="lg" 
                asChild 
                className="text-base px-8 h-14 rounded-xl font-semibold shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40"
              >
                <Link href="/login">
                  Plan Your Trip
              ...
              <Button 
                ...
                variant="outline" 
                asChild 
                className="text-base px-8 h-14 rounded-xl font-semibold border-2"
              >
          ...
          <div className="relative lg:ml-8">
            ...
            {/* Floating stat card */}
            <div className="absolute -bottom-8 -left-8 bg-white p-6 rounded-2xl shadow-2xl border border-border hidden lg:block">
